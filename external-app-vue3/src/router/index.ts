...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/app/space-intent/:id', name: 'space-intent', component: () => import('@/views/mobile/SpaceIntentForm.vue'), meta: { title: '提交意向单' } },
    ...
    { path: '/portal/space-intent/:id', name: 'portal-space-intent', component: () => import('@/views/mobile/SpaceIntentForm.vue'), meta: { title: '提交意向单' } },
