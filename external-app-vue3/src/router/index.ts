...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin/orders/intents/:id', name: 'admin-order-intent-detail', component: () => import('@/views/admin/SpaceIntentDetail.vue'), meta: { title: '意向单详情' } },
    ...
    { path: '/admin/space-intents', redirect: '/admin/orders' },
    { path: '/admin/space-intents/:id', redirect: (to) => `/admin/orders/intents/${String(to.params.id)}` },
